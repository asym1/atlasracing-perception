...
# # YOLOv26
# benchmark(model="/home/amr/Dev/atlasracing-perception/yolo_models/YOLOv26_1280x1280/yolo26n_1280/weights/best.pt", data=DATA, imgsz=1280, half=False, device=0, format="engine")
# benchmark(model="/home/amr/Dev/atlasracing-perception/yolo_models/YOLOv26_1280x1280/yolo26s_1280/weights/best.pt", data=DATA, imgsz=1280, half=False, device=0, format="engine")
# benchmark(model="/home/amr/Dev/atlasracing-perception/yolo_models/YOLOv26_1280x1280/yolo26m_1280/weights/best.pt", data=DATA, imgsz=1280, half=False, device=0, format="engine")
...
results = model.val(data=DATA, imgsz=1280, plots=True)
